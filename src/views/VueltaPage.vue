      ...
      <ion-content>
        ...
        <div class="flight-header">
          <div class="left-section">
            <div class="flight-type">
              ...
              <span class="type-text">VUELTA</span>
            </div>
          </div>
          <div class="center-section">
            <h2>ESTAMBUL - BARCELONA</h2>
        ...
        <div v-if="selectedDate === '25'">
          ...
          <div class="flight-card">
            ...
            <router-link to="/passenger" class="no-underline">
            <ion-button expand="block" class="price-button" :to="'/vuelta'">
              197 €
            </ion-button>
            </router-link>
          </div>
